...
public class RobotContainer {
    ...
    private HangerSubsystem m_hangerSubsystem;
    ...
    private Command m_hangerCommand;
    ...
    */
    ...
    private void initializeCommands() {
        ...
        m_intakeCommand = new IntakeCommand(m_driverGamePad);
        m_aimCommand = new AimCommand(m_driverGamePad);
        m_shooterCommand = new ShooterCommand(m_driverGamePad);
        m_hangerCommand = new HangerCommand(m_driverGamePad);
    ...
    */
    ...
    public HangerSubsystem getHangerSubsystem() { return m_hangerSubsystem; }
    ...
    public Command getCommand(String option) {
        if ( option.equals("DRIVECOMMAND") )
           ...
           return m_intakeCommand;
            ...
            return m_aimCommand;
        else if ( option.equals("HANGERCOMMAND") )
            return m_hangerCommand;
        else 
            return null;
    }
